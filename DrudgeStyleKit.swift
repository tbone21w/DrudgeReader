...
//  Drudge
//
//  Created by Todd Isaacs on 5/31/16.
...
public class DrudgeStyleKit : NSObject {
    ...
    public class func drawPicture() {
        //// Color Declarations
        let logoBaseSemiTransparent = DrudgeStyleKit.logoBaseColor.colorWithAlpha(0.2)

        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(roundedRect: CGRect(x: 2.19, y: 9.02, width: 56.06, height: 41.72), cornerRadius: 3)
        logoBaseSemiTransparent.setStroke()
        ...
        bezierPath.closePath()
        logoBaseSemiTransparent.setFill()
        bezierPath.fill()
        logoBaseSemiTransparent.setStroke()
