...
//  Drudge
//
//  Created by Todd Isaacs on 6/2/16.
...
public class DrudgeStyleKit : NSObject {
    ...
    private struct Cache {
        ...
        static let white: UIColor = UIColor(red: 0.983, green: 0.982, blue: 0.992, alpha: 1.000)
    ...
    public class func drawHeadline_icon() {
        ...
        //// Rectangle 2 Drawing
        let rectangle2Path = UIBezierPath(rect: CGRect(x: 6, y: 4.25, width: 8, height: 5.25))
        DrudgeStyleKit.logoFill.setFill()
        rectangle2Path.fill()
        DrudgeStyleKit.logoStroke.setStroke()
        ...
        starPath.moveToPoint(CGPoint(x: 11.5, y: 5.5))
        starPath.addLineToPoint(CGPoint(x: 11.86, y: 6.5))
        starPath.addLineToPoint(CGPoint(x: 12.93, y: 6.54))
        starPath.addLineToPoint(CGPoint(x: 12.09, y: 7.19))
        starPath.addLineToPoint(CGPoint(x: 12.38, y: 8.21))
        starPath.addLineToPoint(CGPoint(x: 11.5, y: 7.62))
        starPath.addLineToPoint(CGPoint(x: 10.62, y: 8.21))
        starPath.addLineToPoint(CGPoint(x: 10.91, y: 7.19))
        starPath.addLineToPoint(CGPoint(x: 10.07, y: 6.54))
        starPath.addLineToPoint(CGPoint(x: 11.14, y: 6.5))
        starPath.closePath()
        DrudgeStyleKit.white.setFill()
        starPath.fill()
        DrudgeStyleKit.white.setStroke()
    ...
    public class func drawTop_story() {
        ...
        bezier9Path.moveToPoint(CGPoint(x: 9.01, y: 15.5))
        bezier9Path.addLineToPoint(CGPoint(x: 9.01, y: 8.99))
        bezier9Path.addLineToPoint(CGPoint(x: 6.5, y: 8.99))
        bezier9Path.addLineToPoint(CGPoint(x: 9.91, y: 4.5))
        bezier9Path.addLineToPoint(CGPoint(x: 13.5, y: 8.99))
        bezier9Path.addLineToPoint(CGPoint(x: 10.99, y: 8.99))
        bezier9Path.addLineToPoint(CGPoint(x: 10.99, y: 15.5))
        bezier9Path.addLineToPoint(CGPoint(x: 9.01, y: 15.5))
    ...
    public class func drawCanvas2() {
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.moveToPoint(CGPoint(x: 98.73, y: 134.5))
        bezierPath.addLineToPoint(CGPoint(x: 98.73, y: 123.26))
        bezierPath.addLineToPoint(CGPoint(x: 95.5, y: 123.26))
        bezierPath.addLineToPoint(CGPoint(x: 99.88, y: 115.5))
        bezierPath.addLineToPoint(CGPoint(x: 104.5, y: 123.26))
        bezierPath.addLineToPoint(CGPoint(x: 101.27, y: 123.26))
        bezierPath.addLineToPoint(CGPoint(x: 101.27, y: 134.5))
        bezierPath.addLineToPoint(CGPoint(x: 98.73, y: 134.5))
        bezierPath.closePath()
